DROP SEQUENCE student_student_id_seq CASCADE;
DROP SEQUENCE expense_history_record_id_seq CASCADE;
DROP SEQUENCE expenses_expense_id_seq CASCADE;
DROP SEQUENCE form_form_id_seq CASCADE;
DROP SEQUENCE person_person_id_seq CASCADE;
DROP SEQUENCE student_parent_st_pa_id_seq CASCADE;


DROP TABLE PARENT CASCADE;
DROP TABLE EXPENSE_HISTORY CASCADE;
DROP TABLE EXPENSES CASCADE;
DROP TABLE FORM CASCADE;
DROP TABLE PAYMENT_FROM_STUDENT_TO_ACCOUNT CASCADE;
